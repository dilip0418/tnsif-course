...
public class TreeSetExample {
	...
	public static void main(String[] args) {
		 ...
		 * Set<Student> students = new TreeSet<>(Student.ageComparator); Set<Student>
		 * students = new TreeSet<>(Student.nameAgeComparator);
		 * 
		 * students.add(new Student(101,"Gani",23)); students.add(new
		 * Student(102,"Shivesh",23)); students.add(new Student(103,"Rohith",22));
		 * students.add(new Student(104,"Ravi",25)); students.add(new
		 * Student(105,"Ravi",21)); students.add(new Student(106,"Mahesh",24));
		 * 
		 * // System.out.println(students);
		 * 
		 * Iterator<Student> it = students.iterator(); while(it.hasNext()) {
		 * System.out.println(it.next()); }
		 */
	}
